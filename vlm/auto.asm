...
seg_a           segment byte public
                ...
                dw      0, seg_c
                dw      offset loc_04b3, seg_a
                dw      offset loc_05af, seg_a
                dw      offset loc_05b2, seg_a
                dw      offset loc_016b, seg_a
                dw      offset loc_00a2, seg_a
                dw      0, 0
                db      "NVlm"
                dw      VLMID_AUTO
...
loc_00a2:
                ...
                jnc     loc_00ae
                shl     bx,1
                jmp     cs:[bx+offset data_9]

loc_00ae:       mov     ax,STATUS_NONEXISTANT_FUNC_CALLED
                retf
