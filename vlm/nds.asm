...
conn_alloc_handle proc    near
                ...
                pop     bp
                retn
conn_alloc_handle endp

conn_validate_handle proc    near
                push    bp
                mov     bp,VLMID_NDS
                push    bp
                mov     bp,VLMID_CONN
