...
loc_498::
                ...
                mov     cx,seg seg_b
                mov     es,cx
                mov     word ptr es:data_216,bx
                mov     word ptr es:data_216+2,ax
                pop     es
                mov     word ptr es:data_190,bx
                mov     word ptr es:data_190+2,ax
                mov     data_279,bx
                mov     word ptr data_279+2,ax
                mov     ax,data_283
                or      ax,ax
                jz      loc_499
                mov     es:data_189,ax
